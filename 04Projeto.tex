...
\begin{table}[H]
\small
\begin{tabular}{|p{2cm}|p{0.7cm}|p{4cm}|p{0.6cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}}
\hline
\multicolumn{8}{|c|}{Sistema Acadêmico}                                                                                                                                                                                                                                                                                                                                                   \\ \hline
Critérios                 & Peso & Desenvolvimento\\Personalizado                              & 1-5 & \begin{tabular}[c]{@{}l@{}}Sistema\\ Pronto\end{tabular}                                     & 1-5 & Terceirização                           & 1-5 \\ \hline
Cronograma                & 5    & \begin{tabular}[c]{@{}l@{}}O cronograma é flexível\end{tabular}                            & 3   & \begin{tabular}[c]{@{}l@{}}O\\ cronograma é curto\end{tabular}                               & 5   & \begin{tabular}[c]{@{}l@{}}O\\ cronograma é curto\end{tabular}                                                                         & 4   \\ \hline
Modificação               & 5    & \begin{tabular}[c]{@{}l@{}}O sistema pode ser\\ modificado\end{tabular}                      & 5   & \begin{tabular}[c]{@{}l@{}}O\\ sistema não pode ser modificado\end{tabular}                  & 2   & \begin{tabular}[c]{@{}l@{}}O\\ sistema pode ser modificado em alguns detalhes\end{tabular}                                             & 3   \\ \hline
Experiência Interna       & 10   & \begin{tabular}[c]{@{}l@{}}O sistema fornece o \\cadastro para clientes\end{tabular}         & 5   & \begin{tabular}[c]{@{}l@{}}O\\ sistema fornece o cadastro para clientes\end{tabular}         & 5   & \begin{tabular}[c]{@{}l@{}}O\\ sistema fornece o cadastro para clientes\end{tabular}                                                   & 5   \\ \hline
Agilidade                 & 20   & \begin{tabular}[c]{@{}l@{}}O sistema é executado\\ de forma rápida e eficiente\end{tabular}  & 5   & \begin{tabular}[c]{@{}l@{}}O\\ sistema é executado de forma rápida e eficiente\end{tabular}  & 5   & \begin{tabular}[c]{@{}l@{}}O\\ sistema é executado de forma rápida e eficiente de acordo com os\\ critérios do fornecedor\end{tabular} & 4   \\ \hline
Qualificações do Proejeto & 10   & \begin{tabular}[c]{@{}l@{}}Há um desejo de\\ desenvolver qualificações\\ internas\end{tabular} & 4   & \begin{tabular}[c]{@{}l@{}}Há\\ um desejo de desenvolver qualificações internas\end{tabular} & 3   & \begin{tabular}[c]{@{}l@{}}As\\ habilidades são estratégicas\end{tabular}                                                              & 4   \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{2cm}|p{0.7cm}|p{4cm}|p{0.6cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}}
\hline
\multicolumn{8}{|c|}{Ecommerce}                                                                                                                                                                                                                                                                                                                                                   \\ \hline
Critérios                 & Peso & Desenvolvimento\\Personalizado                              & 1-5 & \begin{tabular}[c]{@{}l@{}}Sistema\\ Pronto\end{tabular}                                     & 1-5 & Terceirização                           & 1-5 \\ \hline
Cronograma                & 5    & \begin{tabular}[c]{@{}l@{}}O cronograma é flexível\end{tabular}                            & 3   & \begin{tabular}[c]{@{}l@{}}O\\ cronograma é curto\end{tabular}                               & 5   & \begin{tabular}[c]{@{}l@{}}O\\ cronograma é curto\end{tabular}                                                                         & 4   \\ \hline
Modificação               & 5    & \begin{tabular}[c]{@{}l@{}}O sistema pode ser\\ modificado\end{tabular}                      & 5   & \begin{tabular}[c]{@{}l@{}}O\\ sistema não pode ser modificado\end{tabular}                  & 2   & \begin{tabular}[c]{@{}l@{}}O\\ sistema pode ser modificado em alguns detalhes\end{tabular}                                             & 3   \\ \hline
Experiência Interna       & 10   & \begin{tabular}[c]{@{}l@{}}O sistema fornece o \\cadastro para clientes\end{tabular}         & 5   & \begin{tabular}[c]{@{}l@{}}O\\ sistema fornece o cadastro para clientes\end{tabular}         & 5   & \begin{tabular}[c]{@{}l@{}}O\\ sistema fornece o cadastro para clientes\end{tabular}                                                   & 5   \\ \hline
...
\begin{tabular}{|p{2cm}|p{0.7cm}|p{4cm}|p{0.6cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}}
\hline
\multicolumn{8}{|c|}{Sistema de Futebol}                                                                                                                                                                                                                                                                                                                                                   \\ \hline
Critérios                 & Peso & Desenvolvimento\\Personalizado                              & 1-5 & \begin{tabular}[c]{@{}l@{}}Sistema\\ Pronto\end{tabular}                                     & 1-5 & Terceirização                           & 1-5 \\ \hline
Cronograma                & 5    & \begin{tabular}[c]{@{}l@{}}O cronograma é flexível\end{tabular}                            & 3   & \begin{tabular}[c]{@{}l@{}}O\\ cronograma é curto\end{tabular}                               & 5   & \begin{tabular}[c]{@{}l@{}}O\\ cronograma é curto\end{tabular}                                                                         & 4   \\ \hline
Modificação               & 5    & \begin{tabular}[c]{@{}l@{}}O sistema pode ser\\ modificado\end{tabular}                      & 5   & \begin{tabular}[c]{@{}l@{}}O\\ sistema não pode ser modificado\end{tabular}                  & 2   & \begin{tabular}[c]{@{}l@{}}O\\ sistema pode ser modificado em alguns detalhes\end{tabular}                                             & 3   \\ \hline
Experiência Interna       & 10   & \begin{tabular}[c]{@{}l@{}}O sistema fornece o \\cadastro para clientes\end{tabular}         & 5   & \begin{tabular}[c]{@{}l@{}}O\\ sistema fornece o cadastro para clientes\end{tabular}         & 5   & \begin{tabular}[c]{@{}l@{}}O\\ sistema fornece o cadastro para clientes\end{tabular}                                                   & 5   \\ \hline
